...
(let ((background "#062329")
      ...
      (text_darker "#a19857")
      ;;(comments   "#44b340")
      (comments   "#53da4e") ;; this is lighter shade of green
      (punctuation "#8cde94")
      (keywords "#ffffff")
      (variables "#c1d1e3")
      (functions "#ffffff")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-inactive ((t (:inverse-video unspecified
                                            :underline unspecified
                                            :foreground ,background
                                            :background ,text_darker
                                            :box nil))))
   `(powerline-inactive1 ((t (:background ,text_darker :foreground ,background))))
   `(powerline-inactive2 ((t (:background ,text_darker :foreground ,background))))
