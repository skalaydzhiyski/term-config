...
Resets themes selection back to default" nil nil)
...
Enables the next color-theme in the list" t nil)

(autoload 'theme-looper-enable-previous-theme "theme-looper" "\
Enables the previous color-theme in the list" t nil)

(autoload 'theme-looper-enable-random-theme "theme-looper" "\
Enables a random theme from the list" t nil)

(autoload 'theme-looper-reload-current-theme "theme-looper" "\
Reloads the currently activated theme" t nil)

(autoload 'theme-looper-select-theme "theme-looper" "\
Lets user select a theme from a list of favorite ones rendered using ivy API" t nil)

(autoload 'theme-looper-select-theme-from-all "theme-looper" "\
Lets user select a theme from a list of all available themes rendered using ivy API" t nil)
